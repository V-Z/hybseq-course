...
\begin{frame}{Outline}{Target enrichment for plant/animal systematics --- methodological workshop (MB120C117)}
	\begin{multicols}{2}
		\tableofcontents
	\end{multicols}
\end{frame}
